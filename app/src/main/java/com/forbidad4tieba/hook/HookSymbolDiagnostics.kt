...
internal object HookSymbolDiagnostics {
    fun describeSymbols(context: Context, symbols: HookSymbols): String {
        ...
        return """
            ...
            ${fmt("CommentAvatarDirectProfile", "${symbols.pbCommentAvatarWireClass}.${symbols.pbCommentAvatarWireMethod}(PbCommenFloorItemViewHolder,int,PostData,View) -> PostData.${symbols.pbCommentAvatarPostDataUserMethod} holder.{${symbols.pbCommentAvatarHolderHeadField},${symbols.pbCommentAvatarHolderHeadPendantField}}")}
